...
parser.add_argument('-i', '--img', default='test_data/data/kite.jpg',
                    help='VOC or COCO version')
parser.add_argument('-m', '--trained_model', default='logs/RFB512_E_34_4.pth',
...
x = args.img
det='test_data/res/'
save_result(x, bboxes, out_file=det+x.split('/')[-1], namesfile=data_dir+'/coco.names', score_thr=0)
